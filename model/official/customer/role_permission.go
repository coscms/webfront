...
func NewRolePermission(ctx echo.Context) *RolePermission {
	return &RolePermission{
		OfficialCustomerRolePermission: dbschema.NewOfficialCustomerRolePermission(ctx),
	}
}
...
func (u *RolePermission) check() error {
	if len(u.Type) == 0 {
...
func (u *RolePermission) Add() (interface{}, error) {
	...
	return u.OfficialCustomerRolePermission.Insert()
}
...
func (u *RolePermission) Edit(mw func(db.Result) db.Result, args ...interface{}) error {
	...
	return u.OfficialCustomerRolePermission.Update(mw, args...)
}

func (u *RolePermission) Exists(roleID uint, typ string) (bool, error) {
	return u.OfficialCustomerRolePermission.Exists(nil, db.And(
