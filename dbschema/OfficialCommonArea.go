...
type Slice_OfficialCommonArea = factory.Slicex[*OfficialCommonArea]
...
func (a *OfficialCommonArea) CtxFrom(source factory.Model) factory.Model {
...
func (a *OfficialCommonArea) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*OfficialCommonArea:
			err = a.base.FireReaded(a, queryParam, Slice_OfficialCommonArea(*v))
		case []*OfficialCommonArea:
			err = a.base.FireReaded(a, queryParam, Slice_OfficialCommonArea(v))
		case factory.Ranger:
...
func (a *OfficialCommonArea) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *OfficialCommonArea) TrimOverflowText(column string, value string) string {
