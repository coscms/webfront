...
func (a *OfficialPage) GetDiffColumns(old *OfficialPage) (changedCols []interface{}) {
...
func (a *OfficialPage) Save(old *OfficialPage, args ...interface{}) (affected int64, err error) {
	a.Updated = uint(time.Now().Unix())
	if len(a.Disabled) == 0 {
		a.Disabled = "N"
	}
	if old == nil {
		old = NewOfficialPage(a.Context())
		old.CtxFrom(a)
