...
type Slice_OfficialCommonSensitive = factory.Slicex[*OfficialCommonSensitive]
...
func (a *OfficialCommonSensitive) CtxFrom(source factory.Model) factory.Model {
...
func (a *OfficialCommonSensitive) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*OfficialCommonSensitive:
			err = a.base.FireReaded(a, queryParam, Slice_OfficialCommonSensitive(*v))
		case []*OfficialCommonSensitive:
			err = a.base.FireReaded(a, queryParam, Slice_OfficialCommonSensitive(v))
		case factory.Ranger:
...
func (a *OfficialCommonSensitive) Clone() *OfficialCommonSensitive {
	cloned := OfficialCommonSensitive{Id: a.Id, Words: a.Words, Type: a.Type, Disabled: a.Disabled, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *OfficialCommonSensitive) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *OfficialCommonSensitive) TrimOverflowText(column string, value string) string {
