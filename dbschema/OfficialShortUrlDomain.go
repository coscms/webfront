...
type Slice_OfficialShortUrlDomain = factory.Slicex[*OfficialShortUrlDomain]
...
func (a *OfficialShortUrlDomain) CtxFrom(source factory.Model) factory.Model {
...
func (a *OfficialShortUrlDomain) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*OfficialShortUrlDomain:
			err = a.base.FireReaded(a, queryParam, Slice_OfficialShortUrlDomain(*v))
		case []*OfficialShortUrlDomain:
			err = a.base.FireReaded(a, queryParam, Slice_OfficialShortUrlDomain(v))
		case factory.Ranger:
...
func (a *OfficialShortUrlDomain) Clone() *OfficialShortUrlDomain {
	cloned := OfficialShortUrlDomain{Id: a.Id, OwnerId: a.OwnerId, OwnerType: a.OwnerType, Domain: a.Domain, UrlCount: a.UrlCount, Disabled: a.Disabled, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *OfficialShortUrlDomain) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *OfficialShortUrlDomain) TrimOverflowText(column string, value string) string {
