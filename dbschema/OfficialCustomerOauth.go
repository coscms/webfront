...
func (a *OfficialCustomerOauth) GetDiffColumns(old *OfficialCustomerOauth) (changedCols []interface{}) {
...
func (a *OfficialCustomerOauth) Save(old *OfficialCustomerOauth, args ...interface{}) (affected int64, err error) {
	a.Updated = uint(time.Now().Unix())
	if len(a.Type) == 0 {
		a.Type = "wechat"
	}
	if old == nil {
		old = NewOfficialCustomerOauth(a.Context())
		old.CtxFrom(a)
